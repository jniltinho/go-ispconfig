...
- [ ] 1.1 Create the Tailwind v4 `@theme` block with all semantic light-scheme tokens (brand, bg, surface, text, link, success, border, info, danger, thead, dashlet) and all radius tokens set to 0; commit
