...
- [x] 3.1 Implement the solid button variants (default/success/danger), ≤150ms transitions, hover states, and visible AA-contrast focus outlines applied globally; commit
...
- [x] 4.2 Restyle the dashboard as dashlet cards (`#E1E4E9` light background, large module icon, title, full-width button); commit
