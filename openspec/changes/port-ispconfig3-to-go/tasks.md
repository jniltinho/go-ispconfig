...
- [x] 5.3 Custom template override dir (custom-first lookup, [templates] custom_dir config, source logging) + `go-ispconfig templates list/export` CLI (refuse overwrite without --force) — conf-custom parity (D6b)
