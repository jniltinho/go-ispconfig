...
- [ ] 1.1 Inventory all list/form routes in `frontend/src` + router; map to API paths and module. Commit as `docs/ui-qa-inventory.md`.
...
- [ ] 2.1 Sites web domains list+form QA + fixes. Commit.
- [ ] 2.2 Databases + database users list filters/forms QA + fixes. Commit.
...
- [ ] 4.1 DataTable consistency (filter inputs on decorated columns, pagination labels, empty states).
