...
- [ ] 1.5 Implement grant preflight: compare `get_function_list` result against the engine's required-function set, error lists exact missing names; tests. Commit.
