...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.MailAccess"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SpamfilterPolicy"
                        }
                    }
                ],
                "responses": {
        ...
        "/mail/spamfilter/users": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "email, policy_id, priority",
                        "name": "record",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SpamfilterUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/mail/spamfilter/wblists": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "wb, rid, email",
                        "name": "record",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SpamfilterWblist"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.ServerIPOption"
                            }
                        }
                    },
                    "401": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.Fail2banStatus"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/monitor/fail2ban/unban/{jail}/{ip}": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/fail2ban.Status"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                    ...
                    "422": {
                        "description": "Malformed jail name or IP",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    },
        ...
        "/servers/{id}/config/{section}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Section key/value pairs",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.cronRunListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.WebDatabaseUser"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.WebDatabase"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ShellUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/config/{section}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Section name (sites, mail, misc)",
                        "name": "section",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    ...
                    "422": {
                        "description": "Per-field validation errors (e.g. an unsatisfiable password policy)",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    }
    ...
    "definitions": {
        ...
        "api.CronRunItem": {
            ...
            "properties": {
                "end": {
                    "description": "End is the run end unix time.",
                    "type": "integer"
                },
                "exit": {
                    "description": "Exit is the process exit code or HTTP status.",
                    "type": "integer"
                },
                "loglevel": {
                    "description": "Loglevel is the daemon log level stored on the row.",
                    "type": "integer"
                },
                "output": {
                    "description": "Output is the bounded output tail.",
                    "type": "string"
                },
                "start": {
                    "description": "Start is the run start unix time.",
                    "type": "integer"
                },
                "status": {
                    "description": "Status is ok|exit|timeout|error from the cron_run message.",
                    "type": "string"
                },
                "syslog_id": {
                    "description": "SyslogID is the sys_log primary key.",
                    "type": "integer"
                },
                "tstamp": {
                    "description": "Tstamp is the sys_log unix timestamp.",
                    "type": "integer"
                },
                "type": {
                    "description": "Type is the job type at execution time.",
                    "type": "string"
                }
            }
        },
        ...
        "api.Fail2banStatus": {
            ...
            "properties": {
                "available": {
                    "description": "Available is false when fail2ban-client is absent or the daemon is\ndown; the jail list is then empty and the UI shows a hint instead of\nan error.",
                    "type": "boolean"
                },
                "jails": {
                    "description": "Jails carries one entry per live jail with its banned addresses.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/fail2ban.Status"
                    }
        ...
        "api.cronRunListResponse": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.CronRunItem"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "fail2ban.Status": {
            ...
            "properties": {
                "banned_ips": {
                    "description": "BannedIPs are the currently banned addresses.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
                ...
                "currently_banned": {
                    "description": "CurrentlyBanned is the number of active bans.",
                    "type": "integer"
                },
                "currently_failed": {
                    "description": "CurrentlyFailed is the filter's live failure count.",
                    "type": "integer"
                },
                "name": {
                    "description": "Name is the jail name.",
                    "type": "string"
                },
                "total_banned": {
                    "description": "TotalBanned is the cumulative ban count.",
                    "type": "integer"
                },
                "total_failed": {
                    "description": "TotalFailed is the filter's cumulative failure count.",
                    "type": "integer"
                }
            }
        },
        ...
        "model.FTPUser": {
            ...
            "properties": {
                "active": {
                    "description": "default tags: NOT NULL enum/set columns whose Go zero value (\"\")\nis not a valid member under strict mode.",
                    "type": "string"
                },
                "dir": {
                    "type": "string"
        ...
        "model.SpamfilterPolicy": {
            "type": "object",
            "properties": {
                "addrExtensionBadHeader": {
                    "type": "string"
                },
                "addrExtensionBanned": {
                    "type": "string"
                ...
                "policydQuotaInPeriod": {
                    "type": "integer"
                },
                "policydQuotaOut": {
                    "type": "integer"
                },
                "policydQuotaOutPeriod": {
                    "type": "integer"
                },
                "rspamdGreylisting": {
                    "type": "string"
                },
                "rspamdSpamGreylistingLevel": {
                    "type": "number"
                },
                "rspamdSpamKillLevel": {
                    "type": "number"
        ...
        "model.WebDatabaseUser": {
            "type": "object",
            "properties": {
                "databasePassword": {
                    "type": "string"
                },
                "databasePasswordMongo": {
                    "type": "string"
                },
                "databasePasswordPostgres": {
                    "type": "string"
                },
                "databasePasswordSha2": {
                    "type": "string"
                },
                "databaseUser": {
                    "type": "string"
