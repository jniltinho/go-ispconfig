...
type Client struct {
	...
	LimitMailBackup         string `gorm:"column:limit_mail_backup"`
	LimitRelayhost          string `gorm:"column:limit_relayhost"`
	...
	LimitXMPPMuc            string `gorm:"column:limit_xmpp_muc"`
	LimitXMPPAnon           string `gorm:"column:limit_xmpp_anon"`
	LimitXMPPAuthOptions    string `gorm:"column:limit_xmpp_auth_options"`
	LimitXMPPVjud           string `gorm:"column:limit_xmpp_vjud"`
	LimitXMPPProxy          string `gorm:"column:limit_xmpp_proxy"`
	LimitXMPPStatus         string `gorm:"column:limit_xmpp_status"`
	LimitXMPPPastebin       string `gorm:"column:limit_xmpp_pastebin"`
	LimitXMPPHttparchive    string `gorm:"column:limit_xmpp_httparchive"`
	...
	LimitCGI                string `gorm:"column:limit_cgi"`
	LimitSSI                string `gorm:"column:limit_ssi"`
	LimitPerl               string `gorm:"column:limit_perl"`
	LimitRuby               string `gorm:"column:limit_ruby"`
	LimitPython             string `gorm:"column:limit_python"`
	ForceSuexec             string `gorm:"column:force_suexec"`
	LimitHterror            string `gorm:"column:limit_hterror"`
	LimitWildcard           string `gorm:"column:limit_wildcard"`
	LimitSSL                string `gorm:"column:limit_ssl"`
	LimitSSLLetsencrypt     string `gorm:"column:limit_ssl_letsencrypt"`
	...
	LimitBackup             string `gorm:"column:limit_backup"`
	LimitDirectiveSnippets  string `gorm:"column:limit_directive_snippets"`
