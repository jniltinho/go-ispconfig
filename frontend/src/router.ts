...
{ path: 'sites/databases', name: 'sites-databases', component: DatabaseList },
        ...
        { path: 'help', name: 'help', component: ModulePlaceholder, props: { titleKey: 'sidebar.help.about' } },
        { path: 'help/support', name: 'help-support', component: ModulePlaceholder, props: { titleKey: 'sidebar.help.support' } },
        { path: 'help/faq', name: 'help-faq', component: ModulePlaceholder, props: { titleKey: 'sidebar.help.faq' } },
        { path: 'tools', name: 'tools', component: ModulePlaceholder, props: { titleKey: 'sidebar.tools.settings' } },
        {
          path: 'tools/resync',
          name: 'tools-resync',
