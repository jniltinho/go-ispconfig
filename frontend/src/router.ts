    ...
    { path: '/login', name: 'login', component: LoginView },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: MailList,
          props: {
            apiBase: '/mail/aliases', idField: 'forwarding_id', formBase: '/mail/aliases',
        ...
        },
        {
          ...
          component: EntityForm,
          props: { entity: 'aliases', apiBase: '/mail/aliases', backTo: '/mail/aliases' },
        },
        {
          path: 'mail/aliases/:id(\\d+)',
          name: 'mail-aliases-edit',
          component: EntityForm,
          props: (route) => ({ entity: 'aliases', apiBase: '/mail/aliases', backTo: '/mail/aliases', id: String(route.params.id) }),
        },
        {
          path: 'mail/forwards',
          name: 'mail-forwards',
          component: MailList,
          props: {
            apiBase: '/mail/forwards', idField: 'forwarding_id', formBase: '/mail/forwards',
            columns: [{ key: 'source', label: 'Source' }, { key: 'destination', label: 'Destination' }],
        ...
        },
        {
          ...
          component: EntityForm,
          props: { entity: 'forwards', apiBase: '/mail/forwards', backTo: '/mail/forwards' },
        },
        {
          path: 'mail/forwards/:id(\\d+)',
          name: 'mail-forwards-edit',
          component: EntityForm,
          props: (route) => ({ entity: 'forwards', apiBase: '/mail/forwards', backTo: '/mail/forwards', id: String(route.params.id) }),
        },
        {
          path: 'mail/catchalls',
          name: 'mail-catchalls',
          component: MailList,
          props: {
            apiBase: '/mail/catchalls', idField: 'forwarding_id', formBase: '/mail/catchalls',
        ...
        },
        {
          ...
          component: EntityForm,
          props: { entity: 'catchalls', apiBase: '/mail/catchalls', backTo: '/mail/catchalls' },
        },
        {
          path: 'mail/catchalls/:id(\\d+)',
          name: 'mail-catchalls-edit',
          component: EntityForm,
          props: (route) => ({ entity: 'catchalls', apiBase: '/mail/catchalls', backTo: '/mail/catchalls', id: String(route.params.id) }),
        },
        {
          ...
          component: MailList,
          props: {
            apiBase: '/mail/alias-domains', idField: 'forwarding_id', formBase: '/mail/alias-domains',
        ...
        },
        {
          ...
          component: EntityForm,
          props: { entity: 'alias-domains', apiBase: '/mail/alias-domains', backTo: '/mail/alias-domains' },
        },
        {
          path: 'mail/alias-domains/:id(\\d+)',
          name: 'mail-alias-domains-edit',
          component: EntityForm,
          props: (route) => ({ entity: 'alias-domains', apiBase: '/mail/alias-domains', backTo: '/mail/alias-domains', id: String(route.params.id) }),
        },
        {
          ...
          component: MailList,
          props: {
            apiBase: '/mail/transports', idField: 'transport_id', formBase: '/mail/transports',
        ...
        },
        {
          ...
          component: EntityForm,
          props: { entity: 'transports', apiBase: '/mail/transports', backTo: '/mail/transports' },
        },
        {
          path: 'mail/transports/:id(\\d+)',
          name: 'mail-transports-edit',
          component: EntityForm,
          props: (route) => ({ entity: 'transports', apiBase: '/mail/transports', backTo: '/mail/transports', id: String(route.params.id) }),
        },
